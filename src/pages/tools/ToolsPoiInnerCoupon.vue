  ...
  export default {
    ...
    data() {
      return {
        ...
        loading: false,
        tableName: "",
        templateUrl: "http://192.168.3.3:9007/店内领券.xlsx",
    ...
    methods: {
      ...
      run() {
        ...
        app.run("ws://", "update-poi-inner-coupon-acts", {
    ...
    mounted() {
      ...
      app.on("update-poi-inner-coupon-acts-res", (state) => {
        console.log(state);
