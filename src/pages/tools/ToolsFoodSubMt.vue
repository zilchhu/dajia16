  ...
  export default {
    ...
    data() {
      return {
        ...
        loading: false,
        tableName: "",
        templateUrl: 'http://192.168.3.3:9007/美团商品替换表格模板.xlsx'
      };
    },
    computed: {
      columns() {
        return [
          ...
          },
          {
            ...
            width: 90,
            slots: { filterDropdown: "filterDropdown" },
            onFilter: (value, record) => record.替换后分类名称 == value,
          },
          {
            title: "替换后商品名称",
            dataIndex: "替换后商品名称",
            width: 200,
            slots: { filterDropdown: "filterDropdown" },
            onFilter: (value, record) => record.替换后商品名称 == value,
          },
        ];
      },
      scrollX() {
