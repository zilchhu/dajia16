  ...
  export default {
      ...
      columns() {
        return [
          ...
          },
          {
            ...
            dataIndex: "actInfo",
            width: 100,
            sorter: (a, b) => this.toNum(a.actInfo) - this.toNum(b.actInfo),
          },
          {
            title: "折扣价",
            dataIndex: "actPrice",
            width: 100,
            sorter: (a, b) => this.toNum(a.actPrice) - this.toNum(b.actPrice),
          },
          {
            title: "限购数量",
            dataIndex: "orderLimit",
            width: 100,
            sorter: (a, b) => this.toNum(a.orderLimit) - this.toNum(b.orderLimit),
          },
          {
            title: "处理",
            dataIndex: "handle",
    ...
    methods: {
      ...
      save(record) {
        ...
        if (target) {
          new Probs()
            .save("al", record.key, target["handle"])
            .then((res) => {
              console.log(res);
            })
            .catch((err) => {
